...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-16 sticky top-0 z-50 bg-bodyColor flex justify-between items-center font-titleFont border-b-[1px] ">
      <div className="font-bold">Shubham Bhagwat</div>
      <div>
        <ul className="hidden mdl:inline-flex items-center lg:gap-10">
          ...
          {/* Add Resume Download Icon */}
          <li className="pt-3 text-base font-normal tracking-wide cursor-pointer hover:text-designColor duration-300">
            <a
              href="resume.pdf" // Path to the resume file in the assets folder
              download="Shubham_Bhagwat_Resume" // Specify the name for the downloaded file
              className="text-base font-normal text-gray-400 tracking-wide cursor-pointer hover:text-designColor duration-300"
            >
              <FaFileDownload title="Download Resume" className="text-xl" />
            </a>
          </li>
        </ul>
        <span
